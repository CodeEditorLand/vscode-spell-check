...
function GetURI(language: String): String {
	switch (language) {
		case "en":
			return "https://www.polishmywriting.com/proxy.php?url=/checkDocument";

		case "fr":
			return "https://fr.service.afterthedeadline.com/checkDocument";

		case "de":
			return "https://de.service.afterthedeadline.com/checkDocument";

		case "pt":
			return "https://pt.service.afterthedeadline.com/checkDocument";

		case "es":
			return "https://es.service.afterthedeadline.com/checkDocument";
